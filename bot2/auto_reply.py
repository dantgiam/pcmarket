...
CONFIRM_QUESTIONS = {
    ...
    "other_shop": "Спрашивает ли пользователь про другой магазин/точку сети (не про тот, где сейчас идёт переписка) — просит адрес, группу, чат или ссылку на другой магазин?",
